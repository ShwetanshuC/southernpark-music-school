...
class Command(BaseCommand):
    help = "Force-synchronize original content for Southern Park Music School"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('Successfully synchronized all original Southern Park brand content.'))
